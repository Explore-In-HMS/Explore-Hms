...
public class ImageClassificationCameraActivity extends AppCompatActivity {


    //region variablesAndObjects
    private static final String TAG = ImageClassificationCameraActivity.class.getSimpleName();
    ...
    private static final int CAMERA_SWITCH = R.id.btnCameraSwitch;
    ...
    public void onItemClick(View v) {
        switch (v.getId()) {
            case CAMERA_SWITCH:
                ...
                break;
            case IV_INFO:
                Utils.openWebPage(this, getResources().getString(R.string.link_irs_ic));
                break;
            case BACK:
                onBackPressed();
                break;
    ...
    private void createLensEngine() {
        ...
        try {
            mLensEngine.setMachineLearningFrameTransactor(new ImageClassificationTransactorLocal(getApplicationContext()));

 ...
 *
 */
package com.genar.hmssandbox.huawei.feature_mlkit.ui.mlServices.textRelated.generalCardRecognition.cardOperations;
...
public class CardStringUtils {
    ...
    private static final Map<String, String> numberLetterMap = new HashMap<>();

    private CardStringUtils() {

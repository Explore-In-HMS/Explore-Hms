 ...
 *
 */
package com.genar.hmssandbox.huawei.feature_mlkit.ui.cameraOperations.cameraView;
...
public class CameraSelector {
    ...
    private static final String TAG = CameraSelector.class.getSimpleName();
    ...
    /**
     * @return get cameraConfiguration Facing : front or back camera facing
     */
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                Log.e(TAG, "Rotation value invaild: " + this.mRotation);
        }

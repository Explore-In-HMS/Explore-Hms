 ...
 *
 */
package com.genar.hmssandbox.huawei.feature_mlkit.ui.mlServices.imageRelated.imageSegmentation;
...
public class SeekbarColorSelector extends View {
     ...
     * @param context
     */
    public SeekbarColorSelector(Context context) {
        super(context);
    }
     ...
     * @param attrs
     */
    public SeekbarColorSelector(Context context, @Nullable AttributeSet attrs) {
     ...
     * @param defStyleAttr
     */
    public SeekbarColorSelector(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        // R.styleable.ColorSelector -> from attrs.xml in values
    ...
    private void createBitmap() {
        ...
        if (this.mBitmapForColor != null && !this.mBitmapForColor.isRecycled()) {
                this.mBitmapForColor.recycle();
                this.mBitmapForColor = null;
        }

        if (this.mBitmapForIndicator != null && !this.mBitmapForIndicator.isRecycled()) {
    ...
    /**
     * Create Indicator circle Bitmap
     */
    ...
    /**
     * create linear Color Bar Bitmap
     */
    ...
    public interface OnColorSelectorChangeListener {
         ...
         */
        void onColorChanged(SeekbarColorSelector picker, int color);
         ...
         * @param picker ColorSelector.
         */
        void onStartColorSelect(SeekbarColorSelector picker);
         ...
         * @param picker ColorSelector.
         */
        void onStopColorSelect(SeekbarColorSelector picker);
    }

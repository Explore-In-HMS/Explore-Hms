...
package com.genar.hmssandbox.huawei.feature_mlkit.ui.mlServices.textRelated.idCardRecognition;
...
public class VNIdCardRecognitionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MLVnIcrCapture.CallBack idCallBack = new MLVnIcrCapture.CallBack() {
        ...
        public void onFailure(int retCode, Bitmap bitmap) {
            Toast.makeText(VNIdCardRecognitionActivity.this.getApplicationContext(),"Failed", Toast.LENGTH_SHORT).show();

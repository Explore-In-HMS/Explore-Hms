...
package com.genar.hmssandbox.huawei.feature_mlkit.ui.mlServices.faceAndBodyRelated.faceVerification;
...
import static com.genar.hmssandbox.huawei.feature_mlkit.R.layout.activity_face_verification;
...
public class FaceVerificationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setupToolbar() {
        ...
        Util.setToolbar(this, toolbar, getResources().getString(R.string.link_fv));
    }
    ...
    private Bitmap loadPic(Uri picUri, ImageView view) {
        Bitmap pic = null;
        pic = BitmapUtils.getBitmapFromUriWithSize(this, picUri, ((View) view.getParent()).getWidth(),

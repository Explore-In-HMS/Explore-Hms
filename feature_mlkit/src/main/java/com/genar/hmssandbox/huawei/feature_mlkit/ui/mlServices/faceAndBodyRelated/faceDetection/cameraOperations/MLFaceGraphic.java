 ...
 *
 */
package com.genar.hmssandbox.huawei.feature_mlkit.ui.mlServices.faceAndBodyRelated.faceDetection.cameraOperations;
...
public class MLFaceGraphic extends GraphicOverlay.Graphic {
    ...
    public void draw(Canvas canvas) {
        ...
        float x = start;
        float width = 500f;
        float y = overlay.getHeight() - 400.0f;
    ...
    /**
     * getPaint method gives MLFaceShape.TYPE thats created and sets by in MLFaceGraphic method
     * <p>
     * such as if faceShape is TYPE_LEFT_EYE or TYPE_RIGHT_EYE, this methos gives eyePaint thats edited by in MLFaceGraphic method
     *
     * @param faceShape : MLFaceShape
     * @return
     */

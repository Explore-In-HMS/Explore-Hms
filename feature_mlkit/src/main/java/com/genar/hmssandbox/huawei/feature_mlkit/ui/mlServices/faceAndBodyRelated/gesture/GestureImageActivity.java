...
package com.genar.hmssandbox.huawei.feature_mlkit.ui.mlServices.faceAndBodyRelated.gesture;
...
import com.genar.hmssandbox.huawei.feature_mlkit.ui.cameraOperations.transactor.ImageTransactor;

import com.genar.hmssandbox.huawei.feature_mlkit.ui.cameraOperations.utils.BitmapUtils;
import com.genar.hmssandbox.huawei.feature_mlkit.ui.cameraOperations.transactor.GestureTransactor;
import com.genar.hmssandbox.huawei.feature_mlkit.R;
import com.genar.hmssandbox.huawei.feature_mlkit.utils.AddPictureDialog;
...
public final class GestureImageActivity extends BaseActivity implements OnClickListener {
    ...
    private String selectedMode ="Cloud Classification";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String type = null;
        try {
            this.selectedMode = intent.getStringExtra("model_type");
        ...
        } else if (type.equals("select image")) {
            this.selectLocalImage();
        } else {
            this.startCamera();
        }
    ...
    private void loadImageAndSetTransactor() {
        ...
        this.imageBitmap = BitmapUtils.getBitmapFromUriWithSize(GestureImageActivity.this, this.imageUri, this.getMaxWidthOfImage(), this.getMaxHeightOfImage());

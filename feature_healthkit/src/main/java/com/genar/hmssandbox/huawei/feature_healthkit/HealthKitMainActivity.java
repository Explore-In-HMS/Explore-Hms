...
import com.genar.hmssandbox.huawei.feature_healthkit.auth.HealthKitAuthClientActivity;
import com.genar.hmssandbox.huawei.feature_healthkit.auth.HealthKitAuthCloudActivity;
...
public class HealthKitMainActivity extends AppCompatActivity {
    ...
    public void hihealthDataControllerOnclick(View view) {
        Intent intent = new Intent(this, com.genar.hmssandbox.huawei.feature_healthkit.HealthKitDataControllerActivity.class);
    ...
    public void hihealthAutoRecorderOnClick(View view) {
        Intent intent = new Intent(this, com.genar.hmssandbox.huawei.feature_healthkit.HealthKitAutoRecorderControllerActivity.class);
        startActivity(intent);
    }
    ...
    public void onCloudLoginClick(View view) {
        Intent intent = new Intent(com.genar.hmssandbox.huawei.feature_healthkit.HealthKitMainActivity.this, HealthKitAuthCloudActivity.class);
        startActivity(intent);
    }
}

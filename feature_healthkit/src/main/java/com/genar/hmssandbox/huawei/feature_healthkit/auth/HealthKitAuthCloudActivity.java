...
import com.genar.hmssandbox.huawei.feature_healthkit.OkHttpUtilCallback;
...
public class HealthKitAuthCloudActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        loginAuth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HealthKitAuthCloudActivity.this, HealthKitCloudLogin.class);
                HealthKitAuthCloudActivity.this.startActivityForResult(intent, REQUEST_SIGN_IN_LOGIN);
            }
        });

        // listener to retry authorization
        authRetry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                HealthKitAuthCloudActivity.this.checkOrAuthorizeHealth();
            }
        });
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                HealthKitAuthCloudActivity.this.finish();
            }
        });
    }
    ...
    private void checkOrAuthorizeHealth() {
        ...
        mClient.newCall(privacyRequest).enqueue(new OkHttpUtilCallback(response -> {

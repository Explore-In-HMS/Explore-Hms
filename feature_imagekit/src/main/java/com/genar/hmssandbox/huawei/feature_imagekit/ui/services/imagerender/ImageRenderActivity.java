...
package com.genar.hmssandbox.huawei.feature_imagekit.ui.services.imagerender;
...
import com.genar.hmssandbox.huawei.feature_imagekit.utils.FileUtils;
import com.genar.hmssandbox.huawei.feature_imagekit.utils.ImageRenderUtils;
...
public class ImageRenderActivity extends AppCompatActivity {
    ...
    private void changeAnimation(String animationName) {
        ...
        if (imageRenderAPI != null) {
            int initResult = imageRenderAPI.doInit(sourcePath, ApplicationUtils.createAuthJson());

...
package com.hms.explorehms.huawei.ui.mediaeditor.filter;
...
import com.hms.explorehms.huawei.ui.common.bean.FilterData;
...
import com.hms.explorehms.huawei.ui.common.view.tab.TabTop;
...
public class FilterPanelFragment extends BaseFragment {
    ...
    public void initView(View view) {
        ...
        if (ScreenUtil.isRTL()) {
            mSeekBar.setScaleX(Constant.RTL_UI);
            mTabTopLayout.setScaleX(Constant.RTL_UI);
        } else {
            mSeekBar.setScaleX(Constant.LTR_UI);

...
package com.hms.explorehms.huawei.ui.template.bean;
...
public class Constant {
    ...
    public static final String TEMPLATE_KEY_INFO ="templateinfo";

    public static final String TEMPLATE_KEY_DETAIL="templatedetail";
}

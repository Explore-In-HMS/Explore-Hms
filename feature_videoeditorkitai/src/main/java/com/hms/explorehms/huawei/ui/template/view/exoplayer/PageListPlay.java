...
package com.hms.explorehms.huawei.ui.template.view.exoplayer;
...
import com.hms.explorehms.huawei.ui.common.utils.ResUtils;
...
public class PageListPlay {
    ...
    private void refreshRtl() {
        ...
        if (ScreenUtil.isRTL()) {
            defaultTimeBar.setScaleX(Constant.RTL_UI);
        } else {
            defaultTimeBar.setScaleX(Constant.LTR_UI);
        }
    }
}
...
package com.hms.explorehms.huawei.ui.template.module;
...
import com.hms.explorehms.huawei.ui.common.view.dialog.CommonBottomDialog;
import com.hms.explorehms.huawei.ui.mediaeditor.filter.FilterLinearLayoutManager;
...
import com.hms.explorehms.huawei.ui.template.module.activity.TemplateDetailActivity;
import com.hms.explorehms.huawei.ui.template.module.activity.TemplateEditActivity;
import com.hms.explorehms.huawei.ui.template.module.activity.VideoModuleDetailActivity;
import com.hms.explorehms.huawei.ui.template.view.dialog.ModuleComposeDialog;
...
import com.hms.explorehms.huawei.ui.common.utils.BigDecimalUtil;
...
import com.hms.explorehms.huawei.ui.common.view.RotationPopupWiew;
import com.hms.explorehms.huawei.ui.template.adapter.ModulePickSelectAdapter;
...
import com.hms.explorehms.huawei.ui.template.utils.CropDataHelper;
import com.hms.explorehms.huawei.ui.template.utils.ModuleSelectManager;
...
public class VideoModulePickFragment extends BaseFragment {
    ...
    private void tabToEditActivity() {
        ...
        mActivity.startActivityForResult(intent, TemplateEditActivity.REQUEST_EDIT_CODE);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == TemplateEditActivity.REQUEST_EDIT_CODE && resultCode == Constant.RESULT_CODE) {
            ModuleSelectManager.getInstance().destroy();
            closeModule(false);
        } else if (requestCode == TemplateEditActivity.REQUEST_EDIT_CODE && resultCode == RESULT_OK) {
            if (mActivity != null) {

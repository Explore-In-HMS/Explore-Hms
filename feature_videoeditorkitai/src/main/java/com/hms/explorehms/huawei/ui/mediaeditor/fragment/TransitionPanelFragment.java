...
package com.hms.explorehms.huawei.ui.mediaeditor.fragment;
...
import com.hms.explorehms.huawei.ui.mediaeditor.animation.transitionpanel.TransitionPanelViewModel;
import com.hms.explorehms.huawei.ui.mediaeditor.preview.view.TransitionSeekBar;
...
import com.hms.explorehms.huawei.ui.common.adapter.TransitionItemAdapter;
...
public class TransitionPanelFragment extends BaseFragment {
    ...
    public void initView(View view) {
        ...
        if (ScreenUtil.isRTL()) {
            mLineTransition.setScaleX(Constant.RTL_UI);
            transTime.setScaleX(Constant.RTL_UI);
            mTabTopLayout.setScaleX(Constant.RTL_UI);
        } else {
            mLineTransition.setScaleX(Constant.LTR_UI);
            transTime.setScaleX(Constant.LTR_UI);

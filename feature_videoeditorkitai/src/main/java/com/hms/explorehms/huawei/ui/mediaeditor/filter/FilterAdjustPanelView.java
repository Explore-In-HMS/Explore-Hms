...
import com.hms.explorehms.huawei.ui.common.bean.AdjustData;
...
import com.hms.explorehms.huawei.ui.common.adapter.OnEditItemClickListener;
import com.hms.explorehms.huawei.ui.common.adapter.ValueItemAdapter;
...
public class FilterAdjustPanelView extends BaseFragment
    ...
    protected void initView(View view) {
        ...
        if (ScreenUtil.isRTL()) {
            sb_items.setScaleX(Constant.RTL_UI);
        } else {
            sb_items.setScaleX(Constant.LTR_UI);
        }

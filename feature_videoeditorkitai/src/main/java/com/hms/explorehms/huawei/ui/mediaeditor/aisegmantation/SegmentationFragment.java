...
package com.hms.explorehms.huawei.ui.mediaeditor.aisegmantation;
...
public class SegmentationFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        if (ScreenUtil.isRTL()) {
            mSegmentationRecyclerView.setScaleX(Constant.RTL_UI);
        } else {
            mSegmentationRecyclerView.setScaleX(Constant.LTR_UI);
        }

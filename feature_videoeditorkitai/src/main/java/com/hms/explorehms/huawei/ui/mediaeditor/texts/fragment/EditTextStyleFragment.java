...
import com.hms.explorehms.huawei.ui.mediaeditor.preview.view.MySeekBar;
import com.hms.explorehms.huawei.ui.mediaeditor.texts.viewmodel.TextEditFontViewModel;
import com.hms.explorehms.huawei.ui.mediaeditor.trackview.viewmodel.EditPreviewViewModel;
import com.hms.explorehms.huawei.ui.common.utils.FoldScreenUtil;
...
import com.hms.explorehms.huawei.ui.common.adapter.SelectAdapter;
...
import com.hms.explorehms.huawei.ui.common.utils.LanguageUtils;
...
import com.hms.explorehms.huawei.ui.common.view.loading.LoadingIndicatorView;
import com.hms.explorehms.huawei.ui.common.view.tab.TabTopInfo;
import com.hms.explorehms.huawei.ui.common.view.tab.TabTopLayout;
import com.hms.explorehms.huawei.ui.mediaeditor.materialedit.MaterialEditViewModel;
import com.hms.explorehms.huawei.ui.mediaeditor.texts.adapter.EditTextFontAdapter;
import com.hms.explorehms.huawei.ui.mediaeditor.texts.custom.CustomNestedScrollView;
import com.hms.explorehms.huawei.ui.mediaeditor.texts.viewmodel.TextFlowerViewModel;
import com.hms.explorehms.huawei.ui.mediaeditor.texts.viewmodel.TextPanelViewModel;
...
public class EditTextStyleFragment extends Fragment {
    ...
    private void initView(View rootView) {
        ...
        if (ScreenUtil.isRTL()) {
            mTabTopLayout.setScaleX(Constant.RTL_UI);
        } else {
            mTabTopLayout.setScaleX(Constant.LTR_UI);
        }
    ...
    private class ViewPagerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public class TextStyleHolder extends RecyclerView.ViewHolder {
            ...
            TextStyleHolder(@NonNull View itemView) {
                ...
                if (ScreenUtil.isRTL()) {
                    mSeekBarTrans.setScaleX(Constant.RTL_UI);
                } else {
                    mSeekBarTrans.setScaleX(Constant.LTR_UI);
                }
        ...
        public class ColorHolder extends RecyclerView.ViewHolder {
            ...
            ColorHolder(@NonNull View itemView) {
                ...
                if (ScreenUtil.isRTL()) {
                    seekbar.setScaleX(Constant.RTL_UI);
                } else {
                    seekbar.setScaleX(Constant.LTR_UI);
                }
        ...
        public class StrokesColorHolder extends RecyclerView.ViewHolder {
            ...
            StrokesColorHolder(@NonNull View itemView) {
                ...
                mSeekBarTrans = itemView.findViewById(R.id.seekbar);
                if (ScreenUtil.isRTL()) {
                    mSeekBarThickness.setScaleX(Constant.RTL_UI);
                    mSeekBarTrans.setScaleX(Constant.RTL_UI);
                } else {
                    mSeekBarThickness.setScaleX(Constant.LTR_UI);
                    mSeekBarTrans.setScaleX(Constant.LTR_UI);
                }
        ...
        public class ShadowColorHolder extends RecyclerView.ViewHolder {
            ...
            ShadowColorHolder(@NonNull View itemView) {
                ...
                if (ScreenUtil.isRTL()) {
                    seekTrans.setScaleX(Constant.RTL_UI);
                    seekBlur.setScaleX(Constant.RTL_UI);
                    seekAngle.setScaleX(Constant.RTL_UI);
                    seekDis.setScaleX(Constant.RTL_UI);
                } else {
                    seekTrans.setScaleX(Constant.LTR_UI);
                    seekBlur.setScaleX(Constant.LTR_UI);
                    seekAngle.setScaleX(Constant.LTR_UI);
                    seekDis.setScaleX(Constant.LTR_UI);
                }
                customScrollView = itemView.findViewById(R.id.custom_scrollview);
        ...
        public class LabelHolder extends RecyclerView.ViewHolder {
            ...
            LabelHolder(@NonNull View itemView) {
                ...
                if (ScreenUtil.isRTL()) {
                    seekBarTrans.setScaleX(Constant.RTL_UI);
                } else {
                    seekBarTrans.setScaleX(Constant.LTR_UI);
                }
        ...
        public class SetTypeHolder extends RecyclerView.ViewHolder {
            ...
            SetTypeHolder(@NonNull View itemView) {
                ...
                if (ScreenUtil.isRTL()) {
                    wordSpacingSeek.setScaleX(Constant.RTL_UI);
                    wordLeadingSeek.setScaleX(Constant.RTL_UI);
                } else {
                    wordSpacingSeek.setScaleX(Constant.LTR_UI);
                    wordLeadingSeek.setScaleX(Constant.LTR_UI);
                }

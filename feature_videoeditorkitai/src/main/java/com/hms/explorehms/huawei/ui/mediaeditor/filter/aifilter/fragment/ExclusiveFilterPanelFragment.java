...
package com.hms.explorehms.huawei.ui.mediaeditor.filter.aifilter.fragment;
...
import com.hms.explorehms.huawei.ui.mediaeditor.filter.aifilter.viewmodel.ExclusiveFilterPanelViewModel;
...
import com.hms.explorehms.huawei.ui.common.view.ExclusiveFilterPopupView;
...
import com.hms.explorehms.huawei.ui.common.view.dialog.ExclusiveFilterRenameDialog;
import com.hms.explorehms.huawei.ui.mediaeditor.filter.aifilter.activity.CreateFilterActivity;
import com.hms.explorehms.huawei.ui.mediaeditor.filter.aifilter.adapter.ExclusiveFilterItemAdapter;
import com.hms.explorehms.huawei.ui.mediaeditor.preview.view.FilterSeekBar;
...
public class ExclusiveFilterPanelFragment extends BaseFragment {
    ...
    private HVEEffect addFilterEffect(CloudMaterialBean cutContent, long startTime, long endTime) {
        ...
        if (ExclusiveFilterPanelViewModel.FILTER_TYPE_SINGLE.equals(cutContent.getCategoryName())) {

...
package com.hms.explorehms.huawei.ui.mediaeditor.cover;
...
import com.hms.explorehms.huawei.ui.common.view.image.crop.ClipImageView;
...
import com.hms.explorehms.huawei.ui.common.utils.DrawableUtils;
            ...
            public void run() {
                ...
                try {
                    ...
                    String path = FileUtil.saveBitmap(mActivity, mProjectId, bitmap,
                        System.currentTimeMillis() + CoverImageViewModel.SOURCE_COVER_IMAGE_NAME_SUFFIX);

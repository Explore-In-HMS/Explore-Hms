...
package com.hms.explorehms.huawei.ui.mediaeditor.animation.videoanimation.fragment;

import static com.hms.explorehms.huawei.ui.mediaeditor.trackview.bean.MainViewState.EDIT_VIDEO_OPERATION_ANIMATION;
import static com.hms.explorehms.huawei.ui.mediaeditor.trackview.bean.MainViewState.EDIT_VIDEO_STATE_ANIMATION;
...
import com.hms.explorehms.huawei.ui.common.view.AnimationBar;
...
import com.hms.explorehms.huawei.ui.mediaeditor.animation.videoanimation.viewmodel.AnimationViewModel;
...
import com.hms.explorehms.huawei.ui.mediaeditor.animation.videoanimation.adapter.AnimationItemAdapter;
...
import com.hms.explorehms.huawei.ui.mediaeditor.repository.MaterialsRespository;
...
public class AnimationPanelFragment extends BaseFragment implements AnimationBar.OnProgressChangedListener {
    ...
    protected void initView(View view) {
        ...
        if (ScreenUtil.isRTL()) {
            tabTopLayout.setScaleX(Constant.RTL_UI);
            seek_container.setScaleX(Constant.RTL_UI);
            animationText.setScaleX(Constant.RTL_UI);
        } else {
            tabTopLayout.setScaleX(Constant.LTR_UI);
            seek_container.setScaleX(Constant.LTR_UI);
            animationText.setScaleX(Constant.LTR_UI);
        }

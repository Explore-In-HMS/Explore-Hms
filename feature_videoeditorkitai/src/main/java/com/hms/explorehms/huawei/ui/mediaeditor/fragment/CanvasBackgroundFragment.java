...
import com.hms.explorehms.huawei.ui.mediaeditor.effect.adapter.BaseGridLayoutManager;
...
import com.hms.explorehms.huawei.ui.mediaeditor.canvas.CanvasBlurAdapter;
import com.hms.explorehms.huawei.ui.mediaeditor.canvas.CanvasColor2Adapter;
import com.hms.explorehms.huawei.ui.mediaeditor.canvas.CanvasPanelViewModel;
import com.hms.explorehms.huawei.ui.mediaeditor.canvas.CanvasStyleStyleAdapter;
import com.hms.explorehms.huawei.ui.mediapick.activity.PicturePickActivity;
...
public class CanvasBackgroundFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        if (ScreenUtil.isRTL()) {
            mBlurSeek.setScaleX(Constant.RTL_UI);
        } else {
            mBlurSeek.setScaleX(Constant.LTR_UI);
        }

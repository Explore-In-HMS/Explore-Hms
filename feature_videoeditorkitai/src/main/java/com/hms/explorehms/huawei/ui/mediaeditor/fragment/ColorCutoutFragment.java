...
import com.hms.explorehms.huawei.ui.mediaeditor.preview.ColorCutViewModel;
...
import com.hms.explorehms.huawei.ui.common.adapter.ColorCutAdapter;
...
public class ColorCutoutFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        if (ScreenUtil.isRTL()) {
            mMySeekBar.setScaleX(Constant.RTL_UI);
        } else {
            mMySeekBar.setScaleX(Constant.LTR_UI);
        }

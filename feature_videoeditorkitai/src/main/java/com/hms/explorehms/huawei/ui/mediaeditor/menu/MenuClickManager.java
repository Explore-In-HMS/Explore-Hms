...
import com.hms.explorehms.huawei.ui.common.view.loading.LoadingDialogUtils;
...
import com.hms.explorehms.huawei.ui.mediaeditor.aifun.fragment.AiFunFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.aihair.fragment.AiHairFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.aisegmantation.SegmentationViewModel;
import com.hms.explorehms.huawei.ui.mediaeditor.animation.videoanimation.fragment.AnimationPanelFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.audio.activity.AudioPickActivity;
import com.hms.explorehms.huawei.ui.mediaeditor.audio.fragment.SoundEffectFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.effect.fragment.EffectPanelFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.filter.FilterAdjustPanelView;
import com.hms.explorehms.huawei.ui.mediaeditor.filter.FilterPanelFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.filter.aifilter.fragment.ExclusiveFilterPanelFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.AudioSpeedFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.CanvasBackgroundFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.GeneralSpeedFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.GraffitiFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.MaskEffectFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.ObjectFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.TransitionPanelFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.TransparencyPanelFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.VideoProportionFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.fragment.VolumePanelFragment;
...
import com.hms.explorehms.huawei.ui.mediaeditor.pip.PicInPicMixFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.sticker.fragment.StickerPanelFragment;
import com.hms.explorehms.huawei.ui.mediaeditor.sticker.stickeranimation.fragment.StickerAnimationPanelFragment;
...
import com.hms.explorehms.huawei.ui.mediaeditor.trackview.bean.MainViewState;
...
import com.hms.explorehms.huawei.ui.common.utils.CpuUtils;
import com.hms.explorehms.huawei.ui.common.utils.LaneSizeCheckUtils;
import com.hms.explorehms.huawei.ui.common.utils.SPManager;
    ...
    public void handlerClickEvent(int id) {
        switch (id) {
            case MainViewState.EDIT_PIP_STATE_ADD:
                ...
                mActivity.startActivityForResult(startIntent, VideoClipsActivity.ACTION_ADD_PICTURE_IN_REQUEST_CODE);
                break;
            ...
            case MainViewState.EDIT_VIDEO_STATE_REPLACE:
                ...
                mActivity.startActivityForResult(intent, VideoClipsActivity.ACTION_REPLACE_VIDEO_ASSET);
                break;
            ...
            case MainViewState.EDIT_PIP_OPERATION_ADD:
                ...
                mActivity.startActivityForResult(startIntent2, VideoClipsActivity.ACTION_ADD_PICTURE_IN_REQUEST_CODE);
                break;
            ...
            case MainViewState.EDIT_VIDEO_OPERATION_REPLACE:
                ...
                mActivity.startActivityForResult(pipIntent, VideoClipsActivity.ACTION_REPLACE_VIDEO_ASSET);
                break;
            ...
            case MainViewState.EDIT_PIP_OPERATION_REPLACE:
                ...
                mActivity.startActivityForResult(intent2, VideoClipsActivity.ACTION_PIP_VIDEO_ASSET);
                break;

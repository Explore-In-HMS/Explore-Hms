...
package com.hms.explorehms.huawei.ui.mediaeditor.sticker.viewmodel;
...
import com.hms.explorehms.huawei.ui.mediaeditor.sticker.repository.StickerRepository;
...
import com.hms.explorehms.huawei.ui.mediaeditor.cover.CoverImageActivity;
...
public class StickerPanelViewModel extends ViewModel {
    ...
    public HVEStickerAsset replaceStickerAsset(HVEAsset asset, CloudMaterialBean content, long startTime) {
        ...
        if (asset == null) {
            return StickerRepository.addStickerAsset(content, startTime);
        }

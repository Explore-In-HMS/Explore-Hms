...
import com.hms.explorehms.huawei.ui.mediaeditor.graffiti.GraffitiManager;
import com.hms.explorehms.huawei.ui.mediaeditor.graffiti.view.GraffitiView;
...
import com.hms.explorehms.huawei.ui.mediaeditor.preview.MaskEffectViewModel;
import com.hms.explorehms.huawei.ui.mediaeditor.preview.view.MaskEffectContainerView;
...
public class MenuFragment extends Fragment {
    ...
    private int mCurrentViewId = MainViewState.EDIT_VIDEO_STATE;
    ...
    private void initEvent(View view) {
        ...
        menuContentLayout.setOnMenuClickListener(new EditMenuContentLayout.OnMenuClickListener() {
            ...
            public void onFirstMenuClick(EditMenuBean firstMenu) {
                ...
                mMaterialEditViewModel.setEditModel(firstMenu.getId() != MainViewState.EDIT_TEXT_STATE);
                if (mCurrentViewId == MainViewState.EDIT_VIDEO_STATE) {
                    mEditPreviewViewModel.setIsDrawWave();
                }

                mEditViewModel.getItemsFirstSelected().postValue(firstMenu);

                if (mCurrentViewId == MainViewState.EDIT_RATIO_STATE || mCurrentViewId == MainViewState.EDIT_BACKGROUND_STATE) {
            ...
            public void onSecondMenuClick(EditMenuBean secondMenu) {
                ...
                if (mask_container_view != null) {
                    mask_container_view.setVisibility(secondMenu.getId() == MainViewState.EDIT_VIDEO_STATE_MASK ? VISIBLE : GONE);
                }
            }
        ...
        mEditPreviewViewModel.getMainLaneAssetChanged().observe(getViewLifecycleOwner(), hveAsset -> {
            ...
            if (hveAsset != null) {
                if (hveAsset instanceof HVEImageAsset) {
                    ableIds.add(MainViewState.EDIT_VIDEO_STATE_SPEED);
                    ableIds.add(MainViewState.EDIT_VIDEO_STATE_HUMAN_TRACKING);
                    ableIds.add(MainViewState.EDIT_VIDEO_STATE_AI_SEGMENTATION);
                    if (menuContentLayout != null) {
                        menuContentLayout.updateUnAbleMenus(false, ableIds);
                    }
                    ...
                    if (menuContentLayout != null) {
                        ...
                        if (isVideoReverse) {
                            ableIds.add(MainViewState.EDIT_VIDEO_STATE_HUMAN_TRACKING);
                            ableIds.add(MainViewState.EDIT_VIDEO_STATE_BODY_SEG);
                            ableIds.add(MainViewState.EDIT_VIDEO_STATE_HEAD_SEG);
                        }
                        ...
                        if (isHumanTracking || isSegmentation || isBodySegmentation) {
                            ableIds.add(MainViewState.EDIT_VIDEO_STATE_INVERTED);
                        }
                        menuContentLayout.updateUnAbleMenus(false, ableIds);
                    }
                }
                ...
                ableIds.add(MainViewState.EDIT_VIDEO_STATE_PROPORTION);
                if (menuContentLayout != null) {
        ...
        mEditPreviewViewModel.getSelectedUUID().observe(getViewLifecycleOwner(), uuid -> {
            if (mEditPreviewViewModel.getSelectedAsset() == null && mEditPreviewViewModel.getSelectedEffect() == null) {
                ...
                mMaterialEditViewModel.clearMaterialEditData();
                if (mCurrentViewId == MainViewState.EDIT_TEXT_STATE) {
            ...
            if (selectedHveAsset != null) {
                ...
                if (type == WORD) {
                    state = MainViewState.EDIT_TEXT_OPERATION;
                    ...
                    state = MainViewState.EDIT_STICKER_OPERATION;
                    ...
                    state = MainViewState.EDIT_AUDIO_OPERATION;
                } else {
                    if (selectedHveAsset.getLaneIndex() == 0) {
                        state = MainViewState.EDIT_VIDEO_OPERATION;
                        ...
                        state = MainViewState.EDIT_PIP_OPERATION;

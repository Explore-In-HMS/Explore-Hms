...
import com.hms.explorehms.huawei.ui.mediaeditor.speed.CurveSpeedItemAdapter;
import com.hms.explorehms.huawei.ui.mediaeditor.speed.CurveSpeedViewModel;
...
import com.hms.explorehms.huawei.ui.common.view.SpeedBar;
...
public class GeneralSpeedFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        if (ScreenUtil.isRTL()) {
            speedBar.setScaleX(Constant.RTL_UI);
        } else {
            speedBar.setScaleX(Constant.LTR_UI);
        }

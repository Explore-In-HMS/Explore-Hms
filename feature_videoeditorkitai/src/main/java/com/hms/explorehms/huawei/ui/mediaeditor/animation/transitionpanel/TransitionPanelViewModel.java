...
package com.hms.explorehms.huawei.ui.mediaeditor.animation.transitionpanel;
...
public class TransitionPanelViewModel extends AndroidViewModel {
    ...
    public void loadMaterials(HVEColumnInfo content, Integer page) {
        ...
        HVEChildColumnRequest request =
            new HVEChildColumnRequest(content.getColumnId(), page * Constant.PAGE_SIZE, Constant.PAGE_SIZE, false);

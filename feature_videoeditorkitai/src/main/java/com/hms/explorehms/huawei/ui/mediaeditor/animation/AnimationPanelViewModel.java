...
package com.hms.explorehms.huawei.ui.mediaeditor.animation;
...
public class AnimationPanelViewModel extends AndroidViewModel {
    ...
    public void loadMaterials(HVEColumnInfo cutContent, Integer page) {
        ...
        HVEChildColumnRequest request =
            new HVEChildColumnRequest(cutContent.getColumnId(), page * Constant.PAGE_SIZE, Constant.PAGE_SIZE, false);

...
public class MenuViewModel extends AndroidViewModel {
    ...
    public void splitAudio() {
        ...
        String uriString = SPManager.get(EditPreviewViewModel.MUSIC_URI_INFO, getApplication()).getString(hveAsset.getPath(), "");
        ...
        if (isSuccess) {
            ...
            if (audioLane.getAssets().size() > hveAsset.getIndex() + 1) {
                ...
                SPManager.get(EditPreviewViewModel.MUSIC_URI_INFO, getApplication()).put(asset.getPath(), uriString);

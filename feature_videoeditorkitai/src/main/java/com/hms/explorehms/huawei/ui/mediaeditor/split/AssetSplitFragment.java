...
package com.hms.explorehms.huawei.ui.mediaeditor.split;
...
import com.hms.explorehms.huawei.ui.mediaeditor.cover.CoverTrackView;
...
import com.hms.explorehms.huawei.ui.mediaeditor.cover.CoverAdapter;
...
public class AssetSplitFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        if (ScreenUtil.isRTL()) {
            recyclerView.setScaleX(Constant.RTL_UI);
        } else {
            recyclerView.setScaleX(Constant.LTR_UI);
        }

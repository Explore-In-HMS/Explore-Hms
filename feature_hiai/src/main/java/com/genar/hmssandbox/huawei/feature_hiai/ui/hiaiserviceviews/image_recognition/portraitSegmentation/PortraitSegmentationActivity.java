 ...
 *
 */
package com.genar.hmssandbox.huawei.feature_hiai.ui.hiaiserviceviews.image_recognition.portraitSegmentation;
...
import com.genar.hmssandbox.huawei.feature_hiai.R;
import com.genar.hmssandbox.huawei.feature_hiai.constant.ServiceGroupConstants;
import com.genar.hmssandbox.huawei.feature_hiai.ui.hiaiserviceviews.base.BaseServiceActivity;
import com.genar.hmssandbox.huawei.feature_hiai.ui.hiaiserviceviews.base.BaseServiceInterface;
import com.genar.hmssandbox.huawei.feature_hiai.utils.ApplicationUtils;
import com.genar.hmssandbox.huawei.feature_hiai.utils.ImageUtils;
...
public class PortraitSegmentationActivity extends BaseServiceActivity implements BaseServiceInterface {
    ...
    public PortraitSegmentationActivity() {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portrait_segmentation_hiai);
        baseContext = this;
    ...
    private void setupToolbar() {
        Toolbar toolbar = findViewById(R.id.tb_portrait_segmentation_hiai);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        Util.setToolbar(this, toolbar, getResources().getString(R.string.txt_portrait_segmentation_doc_link_hiai));
    }

    @Override
    public void initUI() {
        btnGallery = findViewById(R.id.btn_portrait_segmentation_gallery);
        btnCamera = findViewById(R.id.btn_portrait_segmentation_camera);
        btnRunService = findViewById(R.id.btn_portrait_segmentation_run);
        ivImage = findViewById(R.id.iv_portrait_segmentation);
        ivImageResult = findViewById(R.id.iv_image_portrait_segmentation_result);
        tvResultCode = findViewById(R.id.tv_portrait_segmentation_result_code);
    }
    ...
    public void getResult() {
        ...
        if (imageBitmap != null) {
            ...
            ImageSegmentation imageSegmentation = new ImageSegmentation(PortraitSegmentationActivity.this);

            SegConfiguration segConfiguration = new SegConfiguration.Builder()
                    .setSegmentationType(SegmentationConfiguration.TYPE_PORTRAIT)
            ...
            if (bitmapResult != null) {
                ...
                Toast.makeText(PortraitSegmentationActivity.this, "Return bitmap is null", Toast.LENGTH_LONG).show();
            }

...
package com.genar.hmssandbox.huawei.feature_dynamicability;
...
public class DynamicAbilityTestActivity extends AppCompatActivity {
    ...
    private static final String MODULE_ACTIVITY_NAME ="com.genar.hmssandbox.huawei.feature_dynamicability.dynamicfeaturetest.DynamicFeatureTestActivity";

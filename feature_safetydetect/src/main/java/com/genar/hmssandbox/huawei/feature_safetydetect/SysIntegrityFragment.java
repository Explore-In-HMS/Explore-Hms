 ...
 *
 */
package com.genar.hmssandbox.huawei.feature_safetydetect;
...
public class SysIntegrityFragment extends Fragment implements View.OnClickListener {
    public static final String TAG = com.genar.hmssandbox.huawei.feature_safetydetect.SysIntegrityFragment.class.getSimpleName();

    private static final String APP_ID = "102418005"; //appId for HMS Sandbox

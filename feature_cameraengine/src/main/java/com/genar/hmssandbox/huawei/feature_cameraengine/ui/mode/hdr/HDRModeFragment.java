...
package com.genar.hmssandbox.huawei.feature_cameraengine.ui.mode.hdr;
...
import com.genar.hmssandbox.huawei.feature_cameraengine.application.AppSession;
import com.genar.hmssandbox.huawei.feature_cameraengine.ui.common.AutoFitTextureView;
import com.genar.hmssandbox.huawei.feature_cameraengine.common.DoubleClickHandler;
import com.genar.hmssandbox.huawei.feature_cameraengine.util.ViewUtils;
...
public class HDRModeFragment extends Fragment {
    ...
    private void initUI(){
        ...
        ivLastPhoto = view.findViewById(R.id.iv_last_photo_hdr_camera_engine);
        ivFlash = view.findViewById(R.id.iv_flash_hdr_mode_camera_engine);
    }

...
package com.genar.hmssandbox.huawei.feature_cameraengine.util;
...
import com.genar.hmssandbox.huawei.feature_cameraengine.R;
import com.genar.hmssandbox.huawei.feature_cameraengine.ui.common.ZoomableImageView;
...
public class ViewUtils {
    ...
    public static void showDialogImagePeekView(Activity activity, Context context, File file, String mode) {
        ...
        if(file.exists()){
            ...
            dialogImagePeekView.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(context, com.genar.hmssandbox.huawei.R.color.transparent)));
            ...
            View dialogLayout = View.inflate(new ContextThemeWrapper(context, com.genar.hmssandbox.huawei.R.style.AppTheme), R.layout.dialog_image_peek_view_camera_engine,null);
    ...
    public static void showDialogVideoView(Activity activity,Context context, File file,String mode){
        if(file.exists()){
            ...
            dialogVideoView.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(context, com.genar.hmssandbox.huawei.R.color.transparent)));
            ...
            View dialogLayout = View.inflate(new ContextThemeWrapper(context, com.genar.hmssandbox.huawei.R.style.AppTheme), R.layout.dialog_video_view_camera_engine,null);

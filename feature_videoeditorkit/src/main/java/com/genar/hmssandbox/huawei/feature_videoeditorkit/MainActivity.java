...
import com.genar.hmssandbox.huawei.feature_videoeditorkit.adapter.DraftAdapter;
import com.genar.hmssandbox.huawei.feature_videoeditorkit.util.PermissionUtils;
...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolBar = findViewById(R.id.tb_main_video_editor_kit);
    ...
    private void initView() {
        startEdit = findViewById(R.id.btn_start_editing);

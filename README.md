...
![ #Kits/Services in Sandbox](https://img.shields.io/badge/%20%23Kits%2FServices%20in%20Sandbox-77-yellow) ![% HMS Kit/Service Coverage ](https://img.shields.io/badge/%25%20HMS%20Kit%2FService%20Coverage%20-100%25-orange) ![% Functional Coverage per Kit/Service](https://img.shields.io/badge/%25%20Functional%20Coverage%20per%20Kit%2FService-93%25-yellow) ![% Kit/Service Up-to-Date](https://img.shields.io/badge/%25%20Kit%2FService%20Up--to--Date-96%25-lightgrey)
...
- An Android phone for debugging.<br/>
...
- Automatically Reading an SMS Verification Code.<br/>
...
- Displaying an In-App Message<br/>
...
- Synchronize seek bar with audio playback<br/>
...
- You can learn about the user and running data of your quick app through the Quick app user report and Quick app running report menus.<br/>
...
- Saved games
- Player statistics
- Access to basic game information<br/>
...
- Data Controller
- Signing in and applying for scopes<br/>
...
- Displaying panorama outside an app<br/>
...
- Fetching Values from Remote Configuration<br/>
...
- WifiDetect API: Checks whether the Wi-Fi to be connected is secure.<br/>
...
- Autocomplete: Returns an autocomplete place and a list of suggested places based on the entered keyword.<br/>
...
- Use Preloader to enhance the playback (incomplete)<br/>

    ...
    private void showRealTimeQoeInfo() {
        showQoeDetailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                if (qoeService != null) {
                    try {
                        Bundle qoeInfo = qoeService.queryRealTimeQoe("com.genar.hmssandbox.huawei.feature_wirelesskit");
                        if (qoeInfo == null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                ...
                if (qoeService != null) {
                    try {
                        ret = qoeService.registerNetQoeCallBack("com.genar.hmssandbox.huawei.feature_wirelesskit", callBack);
        ...
        unRegisterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                ...
                if (qoeService != null) {
                    try {
                        ret = qoeService.unRegisterNetQoeCallBack("com.genar.hmssandbox.huawei.feature_wirelesskit", callBack);
                        if(ret == 0){

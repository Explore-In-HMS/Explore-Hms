 ...
 *
 */
package com.hms.explorehms.huawei.feature_arengine.ui.health.render;
...
public class HealthRenderManager implements GLSurfaceView.Renderer {
     ...
     * This method will be called onCreate
     *
     ...
     * to obtain the latest data. This method is called onResume
     *
     ...
     * and onDrawFrame. This method is called onResume
     *
    ...
    public void setHealthParamTable(TableLayout tableLayout) {
        ...
        mHealthParamTable.setGravity(Gravity.CENTER);
    }
    ...
    private TableRow initTableRow(String keyStr, String valueStr) {
        ...
        textViewKey.setTextColor(ContextCompat.getColor(mContext, R.color.colorPrimaryArEngine));
        textViewValue.setTextColor(ContextCompat.getColor(mContext, R.color.colorPrimaryArEngine));

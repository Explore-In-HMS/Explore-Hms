 ...
 *
 */
package com.hms.explorehms.huawei.feature_arengine.ui.face.rendering;
...
import com.hms.explorehms.huawei.feature_arengine.common.TextDisplay;
import com.hms.explorehms.huawei.feature_arengine.common.TextureDisplay;
...
public class FaceRenderManager implements GLSurfaceView.Renderer{
    ...
    private final TextureDisplay mTextureDisplay = new TextureDisplay();

    private final FaceGeometryDisplay mFaceGeometryDisplay = new FaceGeometryDisplay();

    private final TextDisplay mTextDisplay = new TextDisplay();

    private DisplayRotationManager mDisplayRotationManager;

    /**
     * The constructor initializes context and activity.
     * This method will be called when onCreate
     *
     ...
     * to obtain the latest data. This method is called when onResume
     *
     ...
     * is opened by AR Engine. This method is called when onResume
     *
    ...
    /**
     * Set the texture ID for background rendering. This method will be called when onResume
     *
     ...
     * and onDrawFrame. This method is called when onResume
     *
    ...
    /**
     * Set TextView. This object will be used in the UI thread. This method is called when onCreate
     *
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mTextDisplay.setListener(this::showTextViewOnUiThread);
    }

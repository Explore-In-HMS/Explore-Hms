 ...
 */
package com.hms.explorehms.huawei.feature_arengine.ui.face;
...
public class CameraHelper {
     ...
     * This method will be called when onPause
     */
    ...
    boolean openCamera() {
        ...
        try {
            ...
            if (!mCameraOpenCloseLock.tryAcquire(2500, TimeUnit.MILLISECONDS)) {
                throw new AREngineRuntimeException("Time out waiting to lock camera opening.");
            }
    ...
    void closeCamera() {
        try {
            ...
            Thread.currentThread().interrupt();
            throw new AREngineRuntimeException("Interrupted while trying to lock camera closing.", e);
        } finally {
            mCameraOpenCloseLock.release();
        }
    }

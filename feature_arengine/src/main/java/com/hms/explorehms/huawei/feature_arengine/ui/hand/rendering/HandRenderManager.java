...
public class HandRenderManager implements GLSurfaceView.Renderer {
    ...
    private final ArrayList<HandRelatedDisplay> mHandRelatedDisplays = new ArrayList<>();

    private DisplayRotationManager mDisplayRotationManager;

    /**
     * The constructor that passes context and activity. The method will be called onCreate
     *

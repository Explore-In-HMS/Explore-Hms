 ...
 *
 */
package com.genar.hmssandbox.huawei.feature_arengine.ui.body;
...
import com.genar.hmssandbox.huawei.feature_arengine.ui.body.rendering.BodyRenderManager;
...
public class BodyActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_tracking_arengine);
    ...
    private void initUI() {
        ...
        mTextView = findViewById(R.id.tv_body_track_arengine);
        mSurfaceView = findViewById(R.id.gl_body_tracking_arengine);
    }


    private void setupToolbar() {
        Toolbar toolbar = findViewById(R.id.tb_body_track_arengine);

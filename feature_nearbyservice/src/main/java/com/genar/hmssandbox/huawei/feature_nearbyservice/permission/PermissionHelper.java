...
package com.genar.hmssandbox.huawei.feature_nearbyservice.permission;
...
public class PermissionHelper {
    ...
    public PermissionHelper(@NonNull Activity activity,
                            @NonNull PermissionInterface permissionInterface) {
        mActivity = activity;
    ...
    public void requestPermissions() {
        String[] deniedPermissions =
                PermissionUtil.getDeniedPermissions(

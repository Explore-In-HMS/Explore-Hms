...
package com.genar.hmssandbox.huawei.feature_nearbyservice.connection;
...
import com.genar.hmssandbox.huawei.feature_nearbyservice.R;
import com.genar.hmssandbox.huawei.feature_nearbyservice.connection.utils.FileUtil;
...
public class ChatAdapter extends BaseAdapter {
    ...
    private void holderSendFile(SendFileViewHolder sendFileViewHolder, View convertView, MessageBean item) {
        ...
        if(item.isSending()){
            sendFileViewHolder.progressBar.setVisibility(View.VISIBLE);
            sendFileViewHolder.transferredTv.setVisibility(View.VISIBLE);
        }else{
            sendFileViewHolder.progressBar.setVisibility(View.GONE);
            sendFileViewHolder.transferredTv.setVisibility(View.GONE);
        }
    ...
    private void holderReceiveFile(ReceiveFileViewHolder receiveFileViewHolder, View convertView, MessageBean item) {
        ...
        if(item.isSending()){
            receiveFileViewHolder.progressBar.setVisibility(View.VISIBLE);
            receiveFileViewHolder.transferredTv.setVisibility(View.VISIBLE);
        }else{
            receiveFileViewHolder.progressBar.setVisibility(View.GONE);
            receiveFileViewHolder.transferredTv.setVisibility(View.GONE);
        }
        ...
        if (convertView == null) {
            switch (type) {
                ...
                case MessageBean.TYPE_SEND_IMAGE:
                    ...
                    convertView = (ConstraintLayout)LayoutInflater.from(mContext).inflate(R.layout.send_image_item, parent, false);
                ...
                case MessageBean.TYPE_RECEIVE_IMAGE:
                    ...
                    convertView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.receive_image_item, parent, false);
                ...
                case MessageBean.TYPE_SEND_FILE:
                    ...
                    convertView = (CardView) LayoutInflater.from(mContext).inflate(R.layout.send_file_item, parent, false);

...
package com.genar.hmssandbox.huawei.pushkit.service;
...
import com.genar.hmssandbox.huawei.pushkit.NotificationTargetActivityPushKit;
...
public class HuaweiPushServicePushKit extends HmsMessageService {
    ...
    public void onMessageReceived(RemoteMessage message) {
        ...
        intent.setAction(SANDBOX_ACTION);

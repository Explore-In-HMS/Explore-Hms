...
package com.genar.hmssandbox.huawei.mapkit.helper;

import android.graphics.Color;

import com.genar.hmssandbox.huawei.mapkit.model.response.DirectionResponse;
import com.genar.hmssandbox.huawei.mapkit.model.response.Path;
import com.huawei.hms.maps.model.Polyline;
import com.genar.hmssandbox.huawei.mapkit.model.response.Route;
import com.genar.hmssandbox.huawei.mapkit.model.response.Step;
    ...
    private void findPath(
        ...
        for (Step j : path.getSteps()) {
            if (j.getPolyline() != null && !j.getPolyline().isEmpty()) {
                for (com.genar.hmssandbox.huawei.mapkit.model.response.Polyline k : j.getPolyline()) {

...
import com.genar.hmssandbox.huawei.cameratakelib.CameraTakeManager;
import com.genar.hmssandbox.huawei.cameratakelib.SurfaceViewCallback;
import com.genar.hmssandbox.huawei.cameratakelib.listener.CameraTakeListener;
...
import com.genar.hmssandbox.huawei.modelingkit3d.ui.adapter.RecycleImageAdapter;
...
import com.genar.hmssandbox.huawei.modelingresource.view.ResizeAbleSurfaceView;
...
public class CaptureMaterialActivity extends AppCompatActivity implements RecycleImageAdapter.OnItemClickListener, ProgressCustomDialog.OnItemCancelClickListener {
    ...
    private void init() {
        modeling3dTextureEngine = Modeling3dTextureEngine.getInstance(SandboxApplication.app);

...
import com.genar.hmssandbox.huawei.baseapp.fragment.AppGalleryConnectFragment;
import com.genar.hmssandbox.huawei.baseapp.fragment.HmsCoreFragment;
...
public class BaseViewPagerAdapter extends FragmentStateAdapter {
    ...
    public BaseViewPagerAdapter(FragmentManager fragmentManager, Lifecycle lifecycle) {
        ...
        fragmentList.add(new HmsCoreFragment());
...
/*        if(position == 0)
            fragmentBase = new HmsCoreFragment();
        else if(position == 1)
            fragmentBase = new AppGalleryConnectFragment();*/

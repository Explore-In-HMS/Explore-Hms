...
import com.genar.hmssandbox.huawei.pushkit.dialog.GetNotificationDialog;
import com.genar.hmssandbox.huawei.pushkit.dialog.PushMessageDialogPushKit;
import com.genar.hmssandbox.huawei.pushkit.dialog.TopicDialogPushKit;
...
public class MainActivityPushKit extends AppCompatActivity {
     ...
     */
    private static final String SANDBOX_ACTION = "com.genar.hmssandbox.huawei.feature_pushkit.action";
   ...
   */
    ...
    private void initReceiver() {
        ...
        filter.addAction(SANDBOX_ACTION);

...
public class KitModel implements Parcelable {
    ...
    public static List<KitModel> KitList = Arrays.asList(
            ...
            new KitModel("Crash Service", "com.genar.hmssandbox.huawei.feature_crashservice.CrashServiceMainActivity", true, "feature_crashservice", R.drawable.crash_service, KitModel.HmsCategory.Quality),
            ...
            new KitModel("Cloud Hosting", "com.genar.hmssandbox.huawei.feature_cloudhosting.CloudHostingMainActivity", true, "feature_cloudhosting", R.drawable.icon_cloud_hosting, KitModel.HmsCategory.Build),
            ...
            new KitModel("App Bundle", "com.genar.hmssandbox.huawei.feature_appbundle.AppBundleMainActivity", true, "feature_appbundle", R.drawable.app_bundle_icon, KitModel.HmsCategory.Release, KitMode.REFERENCE),
            new KitModel("Preorders", "com.genar.hmssandbox.huawei.feature_preorders.PreordersActivity", true, "feature_preorders", R.drawable.ic_preorder, KitModel.HmsCategory.Release, KitMode.REFERENCE),
            new KitModel("Early Access", "com.genar.hmssandbox.huawei.feature_earlyaccess.EarlyAccessActivity", true, "feature_earlyaccess", R.drawable.ic_earlyaccess, KitModel.HmsCategory.Release, KitMode.REFERENCE),
            new KitModel("App Release", "com.genar.hmssandbox.huawei.feature_apprelease.AppReleaseActivity", true, "feature_apprelease", R.drawable.icon_apprelease, KitModel.HmsCategory.Release, KitMode.REFERENCE),
            new KitModel("App Performance Management", "com.genar.hmssandbox.huawei.feature_apm.AppPerformanceMainActivity", true, "feature_apm", R.drawable.apm_icon, KitModel.HmsCategory.Quality, KitMode.REFERENCE),
            new KitModel("Comments", "com.genar.hmssandbox.huawei.feature_comments.CommentsActivity", true, "feature_comments", R.drawable.icon_comment, KitModel.HmsCategory.Growing, KitMode.REFERENCE),
            new KitModel("Gift Management", "com.genar.hmssandbox.huawei.feature_giftmanagement.GiftManagementActivity", true, "feature_giftmanagement", R.drawable.icon_gift_management, KitModel.HmsCategory.Growing, KitMode.REFERENCE),
            new KitModel("Integration Check", "com.genar.hmssandbox.huawei.feature_integrationcheck.MainIntegrationCheckActivity", true, "feature_integrationcheck", R.drawable.icon_integration_check, KitModel.HmsCategory.Quality, KitMode.REFERENCE),
            new KitModel("Paid Apps", "com.genar.hmssandbox.huawei.feature_paidapps.GeneralFeaturesActivity", true, "feature_paidapps", R.drawable.icon_paid_apps, KitModel.HmsCategory.Earn, KitMode.REFERENCE),
            ...
            new KitModel("Cast Engine", "com.genar.hmssandbox.huawei.feature_castengine.CastEngineMainActivity", true, "feature_castengine", R.drawable.icon_castengine, KitModel.HmsCategory.SmartDevice, KitMode.REFERENCE),
            ...
            new KitModel("WisePlay DRM", "com.genar.hmssandbox.huawei.wiseplaydrm.WisePlayDRMMainActivity", true, "feature_wiseplaydrm", R.drawable.icon_drm, KitModel.HmsCategory.Media, KitMode.REFERENCE),
            ...
            new KitModel("Local Authentication Engine", "com.genar.hmssandbox.huawei.feature_localauthenticationengine.LocalAuthenticationMainActivity", true, "feature_localauthenticationengine", R.drawable.icon_local_auth, HmsCategory.Security, KitMode.REFERENCE),
            new KitModel("Data Security Engine", "com.genar.hmssandbox.huawei.feature_datasecurityengine.GeneralFeaturesActivity", true, "feature_datasecurityengine", R.drawable.datasecurityicon, HmsCategory.Security, KitMode.REFERENCE),

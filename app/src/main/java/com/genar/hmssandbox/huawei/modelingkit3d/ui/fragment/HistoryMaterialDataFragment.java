...
import com.genar.hmssandbox.huawei.modelingkit3d.ui.adapter.RecycleMaterialAdapter;
...
public class HistoryMaterialDataFragment extends Fragment implements RecycleMaterialAdapter.OnItemClickDownloadListener, ProgressCustomDialog.OnItemCancelClickListener {
    ...
    private void initData() {
        ...
        modeling3dTextureTaskUtils = Modeling3dTextureTaskUtils.getInstance(SandboxApplication.app);

...
import com.genar.hmssandbox.huawei.modelingkit3d.ui.widget.HandlerPopDialog;
...
public class RecycleHistoryAdapter extends RecyclerView.Adapter<RecycleHistoryAdapter.DataViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DataViewHolder holder, int position) {
        ...
        holder.ivPoint.setOnClickListener(v -> {
            Modeling3dReconstructTaskUtils magic3DReconstructTaskUtils = Modeling3dReconstructTaskUtils.getInstance(SandboxApplication.app);
            new Thread(){
                @Override
                public void run() {
                    super.run();

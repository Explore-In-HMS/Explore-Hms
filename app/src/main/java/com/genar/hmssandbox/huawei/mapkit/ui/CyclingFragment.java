...
import com.genar.hmssandbox.huawei.databinding.FragmentCyclingBinding;
import com.genar.hmssandbox.huawei.databinding.FragmentDrivingBinding;
import com.genar.hmssandbox.huawei.databinding.FragmentWalkingBinding;
import com.genar.hmssandbox.huawei.mapkit.base.BaseFragment;
import com.genar.hmssandbox.huawei.mapkit.data.Constants;
import com.genar.hmssandbox.huawei.mapkit.data.IVolley;
import com.genar.hmssandbox.huawei.mapkit.data.MyVolleyRequest;
import com.genar.hmssandbox.huawei.mapkit.helper.PolylineHelper;
import com.genar.hmssandbox.huawei.mapkit.model.request.Destination;
import com.genar.hmssandbox.huawei.mapkit.model.request.DirectionRequest;
import com.genar.hmssandbox.huawei.mapkit.model.request.Origin;
import com.genar.hmssandbox.huawei.mapkit.model.response.DirectionResponse;
import com.genar.hmssandbox.huawei.mapkit.myEnums.DirectionType;
import com.genar.hmssandbox.huawei.mapkit.ui.adapter.DirectionsAdapter;
 ...
 */
public class CyclingFragment extends BaseFragment implements IVolley {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return FragmentCyclingBinding.inflate(getLayoutInflater()).getRoot();
    }
    ...
    void allSteps() throws UnsupportedEncodingException, JSONException {
        ...
        if (hMap != null) {
            new MyVolleyRequest(getContext(), this).postRequest(
                    dirReq, DirectionType.CYCLE.getType(),

 ...
 *
 */
package com.genar.hmssandbox.huawei.scankit.action;
...
public class ContactInfoAction {
    public static final String TAG = "ContactAction";
        ...
        if ((contactInfo.getAddressesInfos() != null)) {
            for (HmsScan.AddressInfo address : contactInfo.getAddressesInfos()) {
                if (address.getAddressDetails() != null) {
                    ...
                    contentValues.put(android.provider.ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.StructuredPostal.CONTENT_ITEM_TYPE);
                    StringBuilder addressBuilder = new StringBuilder();
                    for (String addressLine : address.getAddressDetails()) {
                        addressBuilder.append(addressLine);
                    }
                    contentValues.put(android.provider.ContactsContract.CommonDataKinds.StructuredPostal.FORMATTED_ADDRESS, addressBuilder.toString());
    ...
    private static ArrayList<ContentValues> getPhones(HmsScan.ContactDetail contactInfo) {
        ...
        if ((contactInfo.getTelPhoneNumbers() != null)) {
            for (HmsScan.TelPhoneNumber phone : contactInfo.getTelPhoneNumbers()) {
                ContentValues contentValues = new ContentValues();
                contentValues.put(android.provider.ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.Phone.CONTENT_ITEM_TYPE);
                ...
                contentValues.put(android.provider.ContactsContract.CommonDataKinds.Phone.TYPE, type != null ? type : ContactsContract.CommonDataKinds.Phone.TYPE_OTHER);
                data.add(contentValues);
            }
        }
        return data;
    ...
    private static ArrayList<ContentValues> getEmails(HmsScan.ContactDetail contactInfo) {
        ...
        if ((contactInfo.getEmailContents() != null)) {
            for (HmsScan.EmailContent email : contactInfo.getEmailContents()) {
                ContentValues contentValues = new ContentValues();
                contentValues.put(android.provider.ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.Email.CONTENT_ITEM_TYPE);
                ...
                contentValues.put(android.provider.ContactsContract.CommonDataKinds.Email.TYPE, type != null ? type : ContactsContract.CommonDataKinds.Email.TYPE_OTHER);
                data.add(contentValues);
            }
        }
        return data;
    ...
    private static ArrayList<ContentValues> getUrls(HmsScan.ContactDetail contactInfo) {
        ...
        if (contactInfo.getContactLinks() != null) {
            for (String url : contactInfo.getContactLinks()) {
                ContentValues contentValues = new ContentValues();
                contentValues.put(android.provider.ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.Website.CONTENT_ITEM_TYPE);

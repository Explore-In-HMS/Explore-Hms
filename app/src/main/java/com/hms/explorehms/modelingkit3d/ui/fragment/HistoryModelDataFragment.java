 ...
 */
package com.hms.explorehms.modelingkit3d.ui.fragment;
...
import com.hms.explorehms.cameratakelib.utils.LogUtil;
import com.hms.explorehms.modelingkit3d.model.ConstantBean;
import com.hms.explorehms.modelingkit3d.ui.adapter.RecycleHistoryAdapter;
...
public class HistoryModelDataFragment extends Fragment implements RecycleHistoryAdapter.OnItemClickListener , RecycleHistoryAdapter.OnItemClickDownloadListener, ProgressCustomDialog.OnItemCancelClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initEngine();
        magic3DReconstructTaskUtils = Modeling3dReconstructTaskUtils.getInstance(ExploreHMSApplication.app);
    }

    public void initEngine() {
        magic3dReconstructEngine = Modeling3dReconstructEngine.getInstance(ExploreHMSApplication.app);

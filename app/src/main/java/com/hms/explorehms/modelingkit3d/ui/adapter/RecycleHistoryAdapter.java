 ...
 */
package com.hms.explorehms.modelingkit3d.ui.adapter;
...
import com.hms.explorehms.modelingkit3d.ui.widget.HandlerPopDialog;
import com.hms.explorehms.modelingresource.db.TaskInfoAppDb;
...
import com.hms.explorehms.modelingresource.util.FileSizeUtil;
import com.hms.explorehms.modelingresource.util.Utils;
...
public class RecycleHistoryAdapter extends RecyclerView.Adapter<RecycleHistoryAdapter.DataViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DataViewHolder holder, int position) {
            ...
            case ConstantBean.MODELS_RECONSTRUCT_COMPLETED_STATUS:
                ...
                holder.ivShowStatus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                            ...
                            //Old way
                            /* engine.previewModel(news.getTaskId(), ExploreHMSApplication.app, new Modeling3dReconstructPreviewListener() {
                                @Override
        ...
        holder.ivPoint.setOnClickListener(v -> {
            Modeling3dReconstructTaskUtils magic3DReconstructTaskUtils = Modeling3dReconstructTaskUtils.getInstance(ExploreHMSApplication.app);
            new Thread(){
                @Override
                public void run() {
                    super.run();

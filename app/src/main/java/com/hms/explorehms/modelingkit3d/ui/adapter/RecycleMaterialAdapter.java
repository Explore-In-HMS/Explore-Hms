...
import com.hms.explorehms.modelingkit3d.ui.widget.HandlerMaterialPopDialog;
        ...
        switch (news.getStatus()) {
            ...
            case ConstantBean.MATERIAL_RECONSTRUCT_COMPLETED_STATUS:
                ...
                holder.ivShowStatus.setOnClickListener(v -> {
                        ...
                        engine.previewTexture(news.getTaskId(), ExploreHMSApplication.app, new Modeling3dTexturePreviewListener() {
                            @Override

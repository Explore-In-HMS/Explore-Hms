...
import com.hms.explorehms.baseapp.util.DatabaseAppUtils;
import com.hms.explorehms.baseapp.util.DatabaseMaterialAppUtils;
...
public class ExploreHMSApplication extends Application {

    private static final String TAG = "ExploreHMS Application";

    public static ExploreHMSApplication app;
